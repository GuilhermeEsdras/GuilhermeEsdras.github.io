...
btv.AbstractController = function(controlsDiv, treeDiv) {
    ...
    '<div id="animationLegend" class="legend">Animação</div>' +
    ...
    '<input id="continuouslyCheckbox" type="checkbox" checked="checked"/><label for="continuouslyCheckbox">Sem parar</label>' +
    '</div>' +

    '<div class="item">' +
    'Velocidade de movimento: <div id="moveSpeedSlider"></div>' + 
    '</div>' +
    
    '<div class="item">' +
    'Duração do passo: <div id="stepDurationSlider"></div>' + 
    '</div>';
    ...
    '<div id="historyLegend" class="legend">Histórico</div>' +
...
btv.BinarySearchTreeController = function(controlsDiv, treeDiv) {
    ...
    '<div id="algorithmsLegend" class="legend">Algoritmos</div>' +

'<div class="item">' + 
'<form id="BSTRandomBSTreeForm" action="javascript:btv.controller.randomBSTreeButton()">' +
'<input id="BSTRandomBSTreeButton" type="submit" value="Árvore Aleatória"/> ' +
'min: <input id="BSTRandomBSTreeMinText" type="text" value="0" size="1"/> ' +
'máx: <input id="BSTRandomBSTreeMaxText" type="text" value="99" size="1"/>' +
'</form>' +
'</div>' +
...
'<input id="BSTDeleteButton" type="submit" value="Deletar"/> apaga o nó selecionado' +
'</form>' +
'</div>' +

'<div class="item">' + 
'<form id="BSTGetMaxForm" action="javascript:btv.controller.getMaxButton()">' +
'<input id="BSTGetMaxButton" type="submit" value="getMax"/> da (sub)árvore selecionada ' +
'</form>' +  
'</div>' +

'<div class="item">' + 
'<form id="BSTGetMinForm" action="javascript:btv.controller.getMinButton()">' +
'<input id="BSTGetMinButton" type="submit" value="getMin"/> da (sub)árvore selecionada ' +
'</form>' +      
'</div>' +

'<div class="item">' + 
'<form id="BSTGetPredecessorForm" action="javascript:btv.controller.getPredecessorButton()">' +
'<input id="BSTGetPredecessorButton" type="submit" value="Get Predecessor"/> do nó selecionado' +
'</form>' +    
'</div>' + 

'<div class="item">' + 
'<form id="BSTGetSuccessorForm" action="javascript:btv.controller.getSuccessorButton()">' +
'<input id="BSTGetSuccessorButton" type="submit" value="Get Successor"/> do nó selecionado' +
'</form>' +
'</div>' + 

'<div class="item">' + 
'<form id="BSTToPreorderArrayForm" action="javascript:btv.controller.toPreorderArrayButton()">' +
'<input id="BSTToPreorderArrayButton" type="submit" value="preOrdem"/> em forma de Array' +
'</form>' +
'</div>' + 

'<div class="item">' + 
'<form id="BSTToInorderArrayForm" action="javascript:btv.controller.toInorderArrayButton()">' +
'<input id="BSTToInorderArrayButton" type="submit" value="emOrdem"/> em forma de Array' +
'</form>' +
'</div>' + 

'<div class="item">' + 
'<form id="BSTToPostorderArrayForm" action="javascript:btv.controller.toPostorderArrayButton()">' +
'<input id="BSTToPostorderArrayButton" type="submit" value="posOrdem"/> em forma de Array' +
'</form>' +
'</div>';
}
